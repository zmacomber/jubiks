...
public class Jubiks {
    ...
    static final long MAX_ATTEMPTS = 1000000000;
    ...
    public static void main(String[] args) {
        ...
        while ((attempts < MAX_ATTEMPTS) && ((cube == null) || ( ! cube.isSolved()))) {
            ...
            if ((attempts >= 10000000) && ((attempts % 10000000) == 0)) {
            ...
            for (byte x = 1; x <= MAX_MOVES_NEEDED_TO_SOLVE; x++) {
                ...
                int randomFace = splittableRandom.nextInt(6);
                int randomRotation = splittableRandom.nextInt(3);

                if ((x > 1) && (randomFace == previousFace)) {
                    while (randomFace == previousFace) {
                        randomFace = splittableRandom.nextInt(6);
                    }
                }
